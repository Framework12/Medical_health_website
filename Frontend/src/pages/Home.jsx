          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                "Seamless care, boundless reach – our telemedicine platform brings healing to your fingertips, wherever you are. Connecting hearts to health through the power of virtual wellness."
                </p>
            ...
            <div className="flex gap-[30px] justify-end items-center">
              <div>
                <img src={heroImg01} className="w-full rounded-lg" />
              </div>
